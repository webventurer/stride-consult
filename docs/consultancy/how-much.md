...
See [the procurement Recommendation](/consultancy/procurement#recommendation) for which plan to pick — solo users want Max, groups want Team.

## Linear plans

Linear is your issue tracker. It bills per user per month:
